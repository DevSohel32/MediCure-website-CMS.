                            ...
                            <form action="{{ route('admin_post_update', $post->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        ...
                                        <textarea name="short_description" class="form-control h_100">{{ $post->short_description }}</textarea>
                                    </div>
                                    <div class="col-lg-12 mb-3">
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        ...
                                        <textarea name="seo_meta_description" class="form-control h_100">{{ $post->seo_meta_description }}</textarea>
                                    </div>
                                    <div class="col-lg-12 mb-3">
