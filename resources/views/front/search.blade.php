        ...
        <div class="row">
            <div class="col-xl-12 d-flex justify-content-center">
                <div class="breadcrumb__content">
                    <h3 class="title">{{ $global_page_item->blog_search_page_title }} {{ $search_by }}</h3>
                </div>
            </div>
            <div class="col-xl-12 d-flex justify-content-center">
                <div class="breadcrumb-wrap">
                    <nav class="breadcrumb">
                        ...
                        <span property="itemListElement" typeof="ListItem">{{ $search_by }}</span>
                    </nav>
                </div>
            </div>
        </div>
        ...
        <div class="row gy-60">
            <div class="col-lg-8">
                <div class="row gy-40">
                    ...
                    @empty
                    <div class="col-lg-12">
                        <span class="text-danger">{{ __('No posts found') }}</span>
                    </div>
                    @endforelse
                </div>
                @if($posts->hasPages())
