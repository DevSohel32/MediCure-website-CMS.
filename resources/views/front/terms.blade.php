        ...
        <div class="row">
            <div class="col-xl-12 d-flex justify-content-center">
                <div class="breadcrumb__content">
                    <h3 class="title">{{ $global_page_item->terms_page_title }}</h3>
                </div>
            </div>
            <div class="col-xl-12 d-flex justify-content-center">
                <div class="breadcrumb-wrap">
                    <nav class="breadcrumb">
                        ...
                        <span property="itemListElement" typeof="ListItem">{{ $global_page_item->terms_page_title }}</span>
                    </nav>
                </div>
            </div>
        </div>
...
<section class="terms-privacy-page-area overflow-hidden mt-100 mb-100">
    <div class="container">
        <div class="col-xl-12">
            {!! $global_page_item->terms_content !!}
        </div>
    </div>
</section>
<!--======== / Contact Section ========-->
